...
const BookCard = () => {
  ...
  const addToCart = (event) => {
    ...
    if (target.tagName === "BUTTON") {
      const product = {
        ...
        condition: target.parentElement.querySelector("#bookCondition").textContent,
        listedPrice: target.parentElement.querySelector("#bookCondition").textContent,
      };
  ...
  <h5  id='bookTitle' className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
  {data.title}
  </h5>
